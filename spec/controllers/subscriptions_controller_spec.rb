...
RSpec.describe SubscriptionsController, type: :controller do
  ...
  describe 'POST #create' do
    ...
    context 'with invalid attributes' do
      it 'fails to save subscription to a question to DB' do
        expect { post :create, params: { subscription: { question_id: nil }, format: :js } }.to_not change(user.subscriptions, :count)
      end
    end
  end
  ...
  describe 'DELETE #destroy' do
    ...
    it "doesn't delete subscription belonging to somebody else" do
      expect { delete :destroy, params: { id: subscription, format: :js } }.not_to change(Subscription, :count)
    end
  end
